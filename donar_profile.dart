...
class _DonorProfileScreenState extends State<DonorProfileScreen> {
  String profileImage = "https://cdn-icons-png.flaticon.com/512/149/149071.png"; // New working image URL
  String name = "John Doe";
  String phone = "123-456-7890";
  String email = "john.doe@example.com";
  String address = "123 Street, City";
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                final updatedInfo = await Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => EditProfileScreen(name, phone, email, address, bloodGroup)),
                );
